  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg,#0a0e1a,#0f172a)" }}>
      <div className="fade" style={{ background: T.sf, border: "1px solid " + T.bd, borderRadius: 16, padding: 44, width: 380, textAlign: "center" }}>
        ...
        <div style={{ color: T.tm, fontSize: 15, marginBottom: 28 }}>v{VER}</div>
        <input
          placeholder="Email"
          type="email"
          value={email}
        ...
        />
        {error && <div style={{ color: T.dg, fontSize: 14, marginBottom: 10 }}>{error}</div>}
        <button className="bp2" onClick={go} disabled={loading} style={{ width: "100%", padding: 11, fontSize: 16, opacity: loading ? 0.6 : 1 }}>
