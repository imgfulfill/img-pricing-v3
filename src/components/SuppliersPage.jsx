          ...
          <div style={{ background: T.sf, border: "1px solid " + T.bd, borderRadius: 10, padding: 16 }}>
            ...
            {bulkMode && (
              <div style={{ background: T.sa, borderRadius: 8, padding: 10, marginBottom: 10, display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
                ...
                <button className="bg2" onClick={toggleBulkAll} style={{ fontSize: 10, padding: "4px 10px" }}>
                  {bulkSel.size === supPrices.length && supPrices.length > 0 ? "Bỏ chọn" : "Chọn tất cả (" + supPrices.length + ")"}
                </button>
                <button className="bdel" onClick={doBulkDelete} style={{ fontSize: 10, padding: "4px 12px" }} disabled={!bulkSel.size}>
