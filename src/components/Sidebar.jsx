  ...
  return (
    <div style={{ width: 210, minHeight: "100vh", background: T.sf, borderRight: "1px solid " + T.bd, display: "flex", flexDirection: "column", flexShrink: 0 }}>
      <div style={{ padding: "16px 14px", borderBottom: "1px solid " + T.bd }}>
        ...
        <div style={{ fontSize: 12, color: T.td }}>v{VER} · {user.n}</div>
      </div>
          ...
          <div key={m.id}>
            <button
              ...
              style={{
                ...
                borderRadius: 7, marginBottom: 1, fontSize: 14,
            ...
            >
              ...
              {m.children && <span style={{ fontSize: 12, transition: "transform .2s", transform: expanded[m.id] ? "rotate(90deg)" : "rotate(0deg)" }}>▸</span>}
            </button>
                ...
                {m.children.map(c => (
                  <button key={c.id} onClick={() => set(c.id)}
                    style={{
                      ...
                      borderRadius: 6, marginBottom: 1, fontSize: 13,
      ...
      <div style={{ padding: "10px 14px", borderTop: "1px solid " + T.bd }}>
        <button className="bg2" onClick={logout} style={{ width: "100%", fontSize: 13 }}>Đăng xuất</button>
      </div>
    </div>
  );
}
